...
\tikzset
  {
    ...
    summary edge/.style={green!50!black},
  }
...
\begin{enumerate}
  ...
  \item Augmented CDGs and PDGs for each of the three programs are
    ...
    \begin{minipage}[b]{.55\linewidth}
      ...
      \begin{tikzpicture}[
        ...
        \draw[loop left] (4) to node {\footnotesize T} (4);
        \draw (4) -- node[edge label] {T} (5);
    ...
    \newcommand\SDG{%
      ...
      \makebox[\textwidth]{
        \begin{tikzpicture}[node distance=1 and .5, remember picture]
          ...
          \draw[call edge] (8) -- (EC);
          \draw[call edge] (14.east) -| ($(EB)!.55!(EC)$) -- (EC.west);
          ...
          \begin{scope}[data edge]
            ...
            \draw[bend right=3]
              (C-sum-in) to node[edge label] {\code{sum}} (C-sum-out);
  ...
  \item In the following, nodes included in the slice are shaded.
    \begin{enumerate}
        \newpage
      \item The slice according to $\l< \blk{7}, \code{i} \r>$
        \SDG
        \begin{tikzpicture}[remember picture, overlay]
          \foreach \style/\n/\txt in
            {
        ...
        \newpage
      \item The slice according to $\l< \blk{15}, \code{i} \r>$
        \SDG
        \begin{tikzpicture}[remember picture, overlay]
          \foreach \style/\n/\txt in
            {
        ...
        \newpage
      \item The slice according to $\l< \blk{18}, \code{j} \r>$
        \SDG
        \begin{tikzpicture}[remember picture, overlay]
          \foreach \style/\n/\txt in
            {
